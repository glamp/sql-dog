...
module.exports = function(port) {
  ...
  app.get("/about", function(req, res) {
    res.render("about", { title: "SQL Dog | About" });
  });
  
  app.get("/help", function(req, res) {
    res.render("help", { title: "SQL Dog | Help" });
  });
  ...
  io.sockets.on("connection", function(socket) {
    ...
    socket.on("rename", function(data) {
      gists.rename(data.oldname, data.newname, function() {
        console.log(data.oldname + " is now " + data.newname);
      });
    });
